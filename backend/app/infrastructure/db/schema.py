...
CREATE TABLE IF NOT EXISTS {FVG_CANDIDATES_TABLE_NAME} (
    ...
    corrected_fvg_entry_id TEXT NOT NULL,
    algo_verb_token TEXT NOT NULL,
    algo_verb_index INTEGER NOT NULL,
    corrected_verb_token TEXT NOT NULL,
    corrected_verb_index INTEGER NOT NULL,
    algo_noun_token TEXT NOT NULL,
    algo_noun_index INTEGER NOT NULL,
    corrected_noun_token TEXT NOT NULL,
    corrected_noun_index INTEGER NOT NULL,
    algo_prep_token TEXT NOT NULL,
    algo_prep_index INTEGER NOT NULL,
    corrected_prep_token TEXT NOT NULL,
    corrected_prep_index INTEGER NOT NULL,
