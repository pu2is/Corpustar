...
_LEGACY_MODULE_ALIASES = {
    ...
    "document_repository": "app.infrastructure.repositories.documents",
    "remove_document_service": "app.services.document.remove_document_service",
    "processing_repository": "app.infrastructure.repositories.processings",
    ...
    "sentence_repository": "app.infrastructure.repositories.sentences",
