...
const numResults = computed(() => fvgCandidateStore.numResults)
...
<template>
  <header class="shrink-0 flex flex-col gap-1 bg-background-elevated px-3 py-2">
    <div class="flex items-center gap-2">
      <div class="relative flex-1">
        <input v-model="inputValue"
          type="text" placeholder="Fuzzy search (e.g. antrag → beantragen, Beantragung ...)"
    ...
    <p v-if="numResults !== null" class="text-xs text-text-muted">
